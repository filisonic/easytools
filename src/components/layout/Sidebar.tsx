...
import { 
  Users, Briefcase, GitBranch, Calendar, FileText, BarChart, Settings, 
  ChevronRight, ChevronLeft, Home, UserPlus, Search, UserCheck, Shield
} from 'lucide-react';
    ...
    <aside className={cn(
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className={cn(
          ...
          <p className="font-medium">AI Screening Status</p>
          <p>Resume screener active</p>
          <p className="text-[10px]">N8N workflow running</p>
        </div>
      </div>
    </aside>
  );
